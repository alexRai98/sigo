...
<html lang="en">
  ...
  <body >
    <nav class="navbar navbar-expand-md navbar-light bg-info sticky-top">
      ...
      <div class="container">
        <a class="navbar-brand" href="ingresaste.php"><b>ITMS</b></a>
        ...
        <div  class="collapse navbar-collapse" id="colapsa">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="groups.php" aria-selected="true">GROUPS</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="grades.php" aria-selected="false">GRADES</a>
            </li>
          </ul>
